        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -right-12 top-1/2 -translate-y-1/2 transform">
              <Gift className="w-64 h-64 text-white/5 dark:text-red-500/5 animate-pulse" />
            </div>
            <div className="absolute right-32 top-1/4 transform rotate-12">
              <Gift className="w-32 h-32 text-white/3 dark:text-red-500/10 animate-pulse delay-300" />
            </div>
          </div>
        </div>
